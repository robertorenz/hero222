...
/* ---------- pixel art ---------- */
const PAL = {
  k: '#101418', w: '#f8fafc', r: '#dc2626', o: '#f59e0b', y: '#fde047', b: '#2563eb', c: '#22d3ee',
  s: '#f2c9a0', n: '#8b5a2b', g: '#94a3b8', e: '#16a34a', d: '#475569', t: '#d6c08a', a: '#d97706', h: '#1e3a8a'
};
const HERO_BODY = [
  '.....kk.....',
  '...yyyyyy...',
...
const SPR = {
  miner: [
    '...oooooo...', '..oooooooo..', '..oooooooo..', '...ssssss...', '...skssks...', '...ssssss...',
    '..nnnnnnnn.s', '.nnnnnnnnn.s', '.nn.nnnn.nns', '.ss.nnnn.ss.', '....nnnn....', '....nnnn....',
    '....nn.nn...', '....nn.nn...', '...kkk.kkk..', '............'],
  miner2: [
    '...oooooo..s', '..oooooooo.s', '..oooooooo.s', '...ssssss..n', '...skssks..n', '...ssssss.nn',
    '..nnnnnnnnn.', '.nnnnnnnnnn.', '.nn.nnnn....', '.ss.nnnn....', '....nnnn....', '....nnnn....',
    '....nn.nn...', '....nn.nn...', '...kkk.kkk..', '............'],
  bat0: ['k..............k', 'kk............kk', 'kkk....kk....kkk', '.kkkk.kkkk.kkkk.', '..kkkkkrrkkkkk..', '....kkkkkkkk....', '......k..k......', '................'],
  bat1: ['................', '................', '......k..k......', '...kkkkkkkkkk...', 'kkkkkkkrrkkkkkkk', 'kkk...kkkk...kkk', 'k......kk......k', '................'],
  spider: ['..k......k..', '...k....k...', 'k...kkkk...k', '.kkkkkkkkkk.', '..kkkkkkkk..', '..kkrkkrkk..', '.kkkkkkkkkk.', 'k..kkkkkk..k', '...k....k...', '..k......k..'],
  moth0: ['ttt......ttt', 'tttt....tttt', '.tttt..tttt.', '..ttkkkktt..', '..ttkkkktt..', '.tttt..tttt.', 'tttt....tttt', 'ttt......ttt'],
  moth1: ['............', '............', 'tt........tt', 'tttt.kk.tttt', 'tttt.kk.tttt', 'tt........tt', '............', '............'],
  snake0: ['..........ee....', '.........eeee...', '........eerkee..', '........eeee.rr.', '..eeeeeeeee.....', '.eeeeeeeeeee....', 'ee...eeeeeeeee..', 'e.......eeeeeee.', '..........eeee..', '................'],
  snake1: ['..........ee....', '.........eeee...', '........eerkee..', '........eeee....', '..eeeeeeeee.....', '.eeeeeeeeeee....', 'ee...eeeeeeeee..', 'e.......eeeeeee.', '..........eeee..', '................'],
  lantern: ['...kk...', '..kkkk..', '.k....k.', '.kyyyyk.', '.kyyyyk.', '.kyooyk.', '.kyooyk.', '.kyyyyk.', '.k....k.', '..kkkk..', '...kk...', '........'],
  raft: ['nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn', 'nkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkn', 'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn', 'nkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkn', 'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn', '.n............................n.'],
...
function initAssets() {
  ...
  for (let p = 0; p < 4; p++) { sprites.hero[p] = []; for (let l = 0; l < 3; l++) sprites.hero[p][l] = makeSprite([HERO_PROP[p], ...HERO_BODY, ...HERO_LEGS[l]]); }
  sprites.heroL = sprites.hero.map(row => row.map(flip));
  for (const k in SPR) sprites[k] = makeSprite(SPR[k]);
  sprites.batL = [flip(sprites.bat0), flip(sprites.bat1)];
...
class Game {
  ...
  makeEntity(d, L) {
    ...
    switch (d.type) {
      case 'bat': e.w = 16; e.h = 8; e.y0 = e.y + 4; e.y = e.y0; e.vx = -0.8; break;
      case 'spider': {
        e.w = 12; e.h = 10; e.x = d.tx * TILE + 2; e.anchorY = d.ty * TILE;
      ...
      case 'moth': e.w = 12; e.h = 8; e.x0 = e.x + 2; e.y0 = e.y + 4; e.t = (d.tx * 13) % 100; break;
      case 'snake': e.w = 16; e.h = 10; e.y = d.ty * TILE + 6; break;
      case 'lantern': e.w = 8; e.h = 12; e.x = d.tx * TILE + 4; e.y = d.ty * TILE + 2; break;
      case 'miner': e.w = 12; e.h = 16; e.x = d.tx * TILE + 2; break;
      case 'raft': {
  ...
  render() {
    ...
    for (const e of this.entities) {
      ...
      switch (e.type) {
        case 'bat': ctx.drawImage(e.vx < 0 ? sprites['bat' + ((e.t >> 3) & 1)] : sprites.batL[(e.t >> 3) & 1], x, y); break;
        case 'spider': ctx.fillStyle = '#cbd5e1'; ctx.fillRect(x + 5, e.threadY, 1, y - e.threadY + 2); ctx.drawImage(sprites.spider, x, y); break;
    ...
    if (this.state !== 'dying' || (f >> 2) & 1) {
      if (!(this.invuln > 0 && (f >> 2) & 1)) {
        ...
        const leg = p.onGround && p.walk ? ((p.walk >> 3) % 3) : (p.onGround ? 0 : 1);
        const img = (p.facing > 0 ? sprites.hero : sprites.heroL)[prop][leg];
        ctx.drawImage(img, Math.round(p.x) - 1, Math.round(p.y) - 2);
      }
    }
